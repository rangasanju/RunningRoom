    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.runningroom.categoryoptions"/></h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
          ...
          <div class="col-sm-12">
              <div class="col-sm-4">		        
			        <html:button property="method" value="MAIL EXP" styleClass="buttonActivityBeige" onclick="runningRoom('MAIL EXP')" />	
	          </div>   
	          <div class="col-sm-4">		        
			        <html:button property="method" value="COACHING" styleClass="buttonActivityBeige" onclick="runningRoom('COACHING')" />	
	          </div>       	
              <div class="col-sm-4">		        
			        <html:button property="method" value="GOODS" styleClass="buttonActivityBeige" onclick="runningRoom('GOODS')" />
	          </div>   
	      </div>
	      ...
	      <div class="col-sm-12">
	       ...
	       <div class="col-sm-12">
	          <div class="col-sm-4">		        
			        <html:button property="method" value="RAJDHANI" styleClass="buttonActivityBeige" onclick="runningRoom('RAJDHANI')" />
	          </div>       	
              <div class="col-sm-4">		        
			        <div id="bio" ><html:button property="method" value="LADIES" styleClass="buttonActivityBeige" onclick="runningRoom('LADIES')" /></div>
	          </div>   
	          <div class="col-sm-4">		        
			        &nbsp;
	          </div>       	
...
function runningRoom(category)
{		
			 document.forms[0].action ="runningroom.do?method=initiateRunningRoom&category=" + category;
