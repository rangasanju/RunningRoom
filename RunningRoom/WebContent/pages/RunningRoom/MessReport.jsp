          ...
          <div class="row">
					...
					<table class='table table-bordered table-striped table-condensed table-responsive'>
						...
						<tbody>
						   ...
						   <logic:iterate name="MessReportForm" property="myrows" id="record" indexId="j">
							  <tr>
								    <td align="center"  ><bean:write name="record" property="crew_id" />		</td>
									<td align="center"  ><bean:write name="record" property="meal_type" />			</td>
									<td align="center"  ><bean:write name="record" property="food_type" />		</td>
							   </tr>
