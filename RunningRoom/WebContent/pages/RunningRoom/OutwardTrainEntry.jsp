      ...
      <div class="site-wrapper-inner">
          ...
          <div class="masthead clearfix hidden-xs">
           ...
           <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.OutwardTrain"/></h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
		  ...
		  <div class="col-sm-2">
		    	  <label for="inputCrewId" class="control-label col-sm-5 pull-right" style='white-space: nowrap'>Outward Train No</label>
		  </div>
		  <div class="col-sm-3 ">
		    	  <html:text  styleClass="form-control" name="RunningRoomForm" property="outward_train"  /> 
		  </div>
		  <div class="col-sm-4">
		    	  &nbsp;
		  </div>  
...
{	
	...
	document.forms[0].outward_train.value = "";
...
function validate()
{
	...
	var trn_no = trim(document.forms[0].outward_train.value);
	
	if(trn_no=="")
	{
		alert("Please enter outward train no");	
	}
	else
	{
		document.forms[0].action ="runningroom.do?method=saveOutwardTrain" ;
...
function fillText(val)
{
	...
	var train_no = document.forms[0].outward_train.value;
	...
	{
		document.forms[0].outward_train.value = document.forms[0].outward_train.value.substring(0,document.forms[0].outward_train.value.length-1);
	...
	else
	{
		...
		if(idcount < 10)
			document.forms[0].outward_train.value = document.forms[0].outward_train.value + val;
