    ...
    <div class="site-wrapper">
      ...
      <div class="site-wrapper-inner">
          ...
          <div class="inner cover">
            <h1 class="cover-heading"><i18n:message key="label.PAGETITLE.createcrew"/></h1>            
          </div>
          <div class="inner cover">
            &nbsp;            
          </div>
          ...
          <div class="row">
	           		 	...
	           		 	<table class='table table-bordered table-condensed table-responsive'>
	           		 		<thead>
	           		 			<tr>
	           		 				...
	           		 				<th class='text-center'>
	           		 					<html:text name="TayalLoginForm" property="user_id" styleClass="form-control" onkeyup="this.value = this.value.toUpperCase();"/>
	           		 				</th>
	           		 			</tr>
	    	  ...
	    	  <div>	    	  
	    	  	<html:button property="method" value="Add" styleClass="smallbutton" onclick="saveUser()" />		
	    	  </div>
...
{		
	...
	if(trim(document.forms[0].user_id.value) == "")
	{
		alert("Please Enter Crew ID");
	}
	else
	{		
		 document.forms[0].action ="Login.do?method=addUser";
